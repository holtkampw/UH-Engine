...
namespace UHEngine.ScreenManagement
{
    public sealed class ScreenManager
    {
        ...
        public ScreenManager(Game game)
        {
            ...
            ScreenManager.GraphicsDeviceManager = (GraphicsDeviceManager)game.Services.GetService(typeof(IGraphicsDeviceManager));
            ...
            Cursor = new Cursor(Game, Game.Content);
            Cursor.Initialize();
        ...
        public static bool IsPlayScreenActive()
        {
            return screens[screens.Count - 1].Name == "PlayScreen";
        }

        public void UnloadLastScreen()
        {
            if (screens.Count - 2 >= 0)
                screens[screens.Count - 2].UnloadContent();
