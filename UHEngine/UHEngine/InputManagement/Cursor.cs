...
namespace UHEngine.InputManagement
{
    ...
    public class Cursor : DrawableGameComponent
    {
        ...
        public IActionable CurrentModel { get; set; }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.SpriteBatch.Draw(cursorTexture, Position, null, Color.White, 0.0f,
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Game.IsActive && ScreenManager.GraphicsDeviceManager !=null)
            {
                ...
                Viewport vp = ScreenManager.GraphicsDeviceManager.GraphicsDevice.Viewport;
